...
export default function ProductsPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!selectedShopId) {
      setApiError('Please select a shop before adding a product.');
      return false;
    }
    ...
    if (!form.transportationCost || isNaN(transportationCost) || transportationCost < 0)
  ...
  const validateEdit = (): boolean => {
    ...
    if (editState.saleGstRate.trim() && toOptionalRate(editState.saleGstRate) === null)
      errors.saleGstRate = 'Invalid GST percentage.';
    if (
      editState.lowStockAlertQty.trim() &&
      toOptionalThreshold(editState.lowStockAlertQty) === null
    )
      errors.lowStockAlertQty = 'Invalid alert quantity.';
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Add and manage your full product inventory
          </p>
        </div>
          ...
          <div className="flex items-center gap-3 px-6 py-4 border-b border-slate-100 bg-slate-50/60">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Fill in the details below and click Add Product
              </p>
            </div>
          </div>
            ...
            <div className="bg-slate-50/70 border border-slate-200 rounded-2xl p-4 mb-5">
              <div className="flex items-center justify-between gap-3 mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Record buying cost and transport overhead
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-indigo-50 border border-indigo-200 rounded-xl">
                ...
                <p className="text-sm text-indigo-700">
                  {printTarget.restocked ? (
                    <>
                      <span className="font-bold">{printTarget.qty}</span> new barcode label
                      {printTarget.qty !== 1 ? 's' : ''} for the units just added.
                      <br />
              ...
              <p className="text-xs text-slate-400">
                Each label contains a unique Code 128 barcode. Stick one label on each physical
                product unit. Choose a size that fits the product and remains easy to scan.
              </p>
            </div>
            {/* Footer */}
            <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-100 bg-slate-50/50">
              ...
              <button
                onClick={() => {
                  window.open(
                    withBarcodeLabelSize(printTarget.barcodePrintUrl, barcodeLabelSize),
                    '_blank'
                  );
                }}
