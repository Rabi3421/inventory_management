      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <button className="flex items-center gap-2.5 pl-2 pr-3 py-1.5 rounded-lg hover:bg-slate-50 transition-all duration-150 group">
          ...
          <div className="text-left hidden sm:block">
            <p className="text-xs font-semibold text-slate-700 leading-tight">James Adeyemi</p>
            <p className="text-[10px] text-emerald-600 leading-tight font-medium">Shop Admin</p>
          </div>
